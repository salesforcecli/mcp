...
import { ApplyCodeAnalyzerCustomRuleMcpTool } from "./tools/apply_code_analyzer_custom_rule.js";
import { GetNodeDetailsMcpTool } from "./tools/get_code_analyzer_node_details.js";
...
export class CodeAnalyzerMcpProvider extends McpProvider {
    ...
    public provideTools(services: Services): Promise<McpTool[]> {
        ...
        return Promise.resolve([
            ...
            new ApplyCodeAnalyzerCustomRuleMcpTool()
        ]);
    }
}