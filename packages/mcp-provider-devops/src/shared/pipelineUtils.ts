...
/**
 * Retrieves the pipeline ID for a given project.
 */
...
/**
 * Fetches all pipeline stages for a given pipeline.
 */
...
/**
 * Computes the first stage ID from pipeline stages.
 */
...
/**
 * Resolves the target stage ID for promotion from current stage.
 */
...
/**
 * Gets the branch name from a pipeline stage.
 */
