...
import { OfflineAnalysisTool } from "../../src/tools/mobile-offline/offline-analysis/sf-mobile-web-offline-analysis.js";
...
describe("Tests for OfflineAnalysisTool", () => {
  ...
  beforeEach(() => {
    ...
    tool = new OfflineAnalysisTool(telemetryService);
  });
