...
describe("Tests for OfflineGuidanceTool", () => {
  ...
  it("When getConfig is called, then the correct configuration is returned", () => {
    ...
    expect(config.description).toEqual("Provides structured review instructions to detect and remediate Mobile Offline code violations in Lightning web components (LWCs) for Salesforce Mobile Apps.");
